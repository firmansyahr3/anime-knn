...
# LOAD DATA
# ========================
anime = pd.read_csv("C:/Users/DELL/Documents/anime/anime.csv")
rating = pd.read_csv("C:/Users/DELL/Documents/anime/rating.csv")
...
n_neighbors = min(6, user_anime_matrix.shape[0] - 1)

hasil_rekomendasi = []

if n_neighbors < 1:
    st.error("Tidak cukup data untuk rekomendasi.")
else:
...
if not hasil_rekomendasi:
    ...
    hasil_df.index = np.arange(1, len(hasil_df) + 1)
    hasil_df.reset_index(names='No', inplace=True)
...
if user_watched.empty:
    ...
    selected_anime = st.multiselect("✅ Tampilkan hanya anime yang dipilih:", all_anime_watched, default=all_anime_watched)
